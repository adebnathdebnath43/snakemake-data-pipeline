...
def main(users_csv, orders_csv, output_db):
        # ensure parent directories exist for the three paths (works when there's no dirname)
    for p in (output_db, users_csv, orders_csv):
    ...
    # Read CSVs
        ...
        #adding a new auto generated unique primary key column named id to the user_orders table
        #conn.execute('ALTER TABLE user_orders ADD COLUMN id INTEGER PRIMARY KEY AUTOINCREMENT;')
